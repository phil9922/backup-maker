...
- [Scheduled snapshots](snapshots.md) — how to open an encrypted archive, and
  why the password can't be recovered.
- [Security & safety properties](security.md) — the guarantees that make a
  destination worth restoring from.
- [Getting started](getting-started.md) — setting up the fresh machine you just
  adopted onto.
