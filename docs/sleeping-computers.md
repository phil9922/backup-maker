...
> [Raspberry Pi guide](RASPBERRY-PI-SETUP.md).
>
...
> price. See [RECOMMENDED-HARDWARE.md](RECOMMENDED-HARDWARE.md).
>
...
- [Setting up a Raspberry Pi as a backup target](RASPBERRY-PI-SETUP.md) — Fix 1,
  built step by step.
- [RECOMMENDED-HARDWARE.md](RECOMMENDED-HARDWARE.md) — always-on target
  categories, including NAS boxes.
- [Monitoring your backups](monitoring.md) — how to notice a target that has
