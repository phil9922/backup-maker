...
a [status page](monitoring.md#checking-backups-when-your-computer-is-off) you
...
burglary — see [RECOMMENDED-HARDWARE.md](RECOMMENDED-HARDWARE.md).

## See also

- [RECOMMENDED-HARDWARE.md](RECOMMENDED-HARDWARE.md) — what to buy, in
...
- [Sleeping computers](sleeping-computers.md) — why "always-on" is the word
  that matters in the table above.
- [When a destination fills up](space.md) — what happens when the box you chose
  runs out of room.
