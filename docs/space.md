...
- [Choosing destinations](destinations.md) — sizing a destination before you
  buy it, so this page matters less.
- [Scheduled snapshots](snapshots.md) — retention counts, which prune snapshots
  independently of the headroom figure.
- [Reference](reference.md) — where `config.toml` lives.
